...
function main() {
  ...
  var n = initVertexBuffers(gl); //获取u_ViewMatrix,u_ViewMatrix,u_ProjMatrix变量的存储地址
  ...
  projMatrix.setPerspective(30, canvas.width / canvas.height, 1, 100); //将模型矩阵、视图矩阵和投影矩阵传给相应的uniform变量

  gl.uniformMatrix4fv(u_ModelMatrix, false, modelMatrix.elements); //将视图矩阵传给u_viewMatrix变量

  gl.uniformMatrix4fv(u_ViewMatrix, false, viewMatrix.elements);
  gl.uniformMatrix4fv(u_ProjMatrix, false, projMatrix.elements); //设置canvas的背景色
...
function initVertexBuffers(gl) {
  ...
  -0.5, -1.0, -4.0, 0.4, 1.0, 0.4, 0.5, -1.0, -4.0, 1.0, 0.4, 0.4, 0.0, 1.0, -2.0, 1.0, 1.0, 0.4, //黄色三角形在中间
  -0.5, -1.0, -2.0, 1.0, 1.0, 0.4, 0.5, -1.0, -2.0, 1.0, 0.4, 0.4, 0.0, 1.0, 0.0, 0.4, 0.4, 1.0, //蓝色三角形在最前面
  ...
  gl.vertexAttribPointer(a_Position, 3, gl.FLOAT, false, FSIZE * 6, 0); //连接a_Position变量与分配给他的缓冲区对象
  ...
  gl.vertexAttribPointer(a_Color, 3, gl.FLOAT, false, FSIZE * 6, FSIZE * 3); //连接a_Position变量与分配给他的缓冲区对象
